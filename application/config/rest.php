...
$config['auth_override_class_method']['InitController']['*'] = 'none';
$config['auth_override_class_method']['AuthController']['authPhoneTry'] = 'none';
$config['auth_override_class_method']['AuthController']['authPhoneCheck'] = 'none';
$config['auth_override_class_method']['UserController']['regist'] = 'none';
//$config['auth_override_class_method']['UserController']['registTemp'] = 'none';
$config['auth_override_class_method']['UserController']['login'] = 'none';
$config['auth_override_class_method']['UsersettingController']['findPasswordCheck'] = 'none';
$config['auth_override_class_method']['UsersettingController']['findPassword'] = 'none';
$config['auth_override_class_method']['Key']['keyCheck'] = 'none';

$config['auth_override_class_method']['TestController']['*'] = 'none';

$config['auth_override_class_method']['InfoController']['sender'] = 'none';
$config['auth_override_class_method']['InfoController']['currentFee'] = 'none';

$config['auth_override_class_method']['TransactionController']['updateHash'] = 'none';
$config['auth_override_class_method']['TransactionController']['updateReceipt'] = 'none';
...
$config['rest_key_lifetime'] = '43200'; // minute
